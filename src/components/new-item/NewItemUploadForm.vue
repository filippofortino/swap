...
export default {
  ...
  methods: {
    ...
    appendFileToList(error, uploadedFile) {
      ...
      // Attach and id generated by filepond to be able
      // to retrieve the file if the user decides to revert
      // the upload
      fileToAppend.filepondId = uploadedFile.id
    ...
    /**
     * Get the uploaded file data and extract filepond serverId.k
     */
